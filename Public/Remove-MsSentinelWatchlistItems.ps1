...
function Remove-MsSentinelWatchlistItems {
  <#
.Synopsis
   Create a Microsoft Sentinel Watchlist
.DESCRIPTION
   This function can be used to remove an item from  a Microsoft Sentinel watchlist.
.PARAMETER WorkspaceName
Enter the Workspace name
.PARAMETER AliasName
Enter the aliasname for the watchlist
.PARAMETER ItemValue
Enter the value(s) to remove from the watchlist
.EXAMPLE
